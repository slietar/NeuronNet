...
/*!
 ...
 ./NeuronNet -T IB:0.2,CH:0.15 -N 800 -d 100 -o test1000 -t 1000
  \endverbatim
  which will create a \ref Network "network" of 800 \ref Neuron "neurons" consisting of 20% of *IB* neurons, 15% of *CH* neurons and *RS* neurons (see Neuron::NeuronTypes).
